								...
								<ul class="menu-nav nav">
									<li class="nav-item">
										<a class="nav-link with-sub" href="javascript:void(0);">
											...
											<span class="sidemenu-label">Gestion events</span>
											<i class="angle fe fe-chevron-right"></i>
										</a>
										<ul class="nav-sub">
											<li class="side-menu-label1"><a href="javascript:void(0);">Gestion events</a></li>
											<li class="nav-sub-item">
												<a class="nav-sub-link" href="{{route('event')}}">List events</a>
											</li>
											<li class="nav-sub-item">
