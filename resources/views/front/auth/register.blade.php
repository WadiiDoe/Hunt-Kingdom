						...
						<div class="row row-sm">
										...
										<div class="card-body mt-2 mb-2">
											...
											<p class="mb-4 text-muted tx-13 ms-0 text-start">It's Free to Sign up and only takes a minute.</p>
												...
												<div class="form-group text-start">
													...
													<input class="form-control" id="name" placeholder="Enter your Name" type="text" name="name" :value="old('name')" >
												</div>
												<div class="form-group text-start">
													<label class="tx-medium">Email</label>
													<input class="form-control" placeholder="Enter your email" id="email" type="email"  name="email" :value="old('email')" autocomplete="username">
												</div>
												<div class="form-group text-start">
													<label class="tx-medium">Password</label>
													<input class="form-control border-end-0" placeholder="Enter your password" autocomplete="new-password" type="password"  id="password" name="password" data-bs-toggle="password">
												</div>
												<div class="form-group text-start">
													<label class="tx-medium">Confirm your password</label>
													<input class="form-control border-end-0" id="password_confirmation" class="block mt-1 w-full"
                                type="password"
                                name="password_confirmation" required data-bs-toggle="password">
												</div>
							...
							<div class="col-lg-6 col-xl-6 d-none d-lg-block text-center bg-primary details rounded-end-11">
								<div class="mt-4 pt-5 p-2 pos-relative">
									<img src="{{asset('build/assets/img/brand/logo-light.png')}}" class="header-brand-img mb-3 mt-3" alt="logo">
									<div class="clearfix"></div>
