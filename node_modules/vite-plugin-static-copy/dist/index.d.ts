 ...
 */
declare type TransformFunc<T extends string | Buffer> = (content: T, filename: string) => T | null;
declare type RenameFunc = (fileName: string, fileExtension: string, fullPath: string) => string;
...
export { Target, TransformOption, ViteStaticCopyOptions, viteStaticCopy };
